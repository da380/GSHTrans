...
/**
 * @file RadialSplineDerivative.hpp
 ...
 * `const`, which is exactly the contract RadialOperator.hpp asks an operator to
...
/// polynomial of RadialDerivatives.hpp: global like the differentiation matrix,
