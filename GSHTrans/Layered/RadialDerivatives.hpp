...
// of the two obligations RadialOperator.hpp states. Every one of these does all
...
// SplineDerivative is the fourth and lives in RadialSplineDerivative.hpp,
// because it is built on Interpolation's factorised spline system and so exists
// only when that dependency does.
