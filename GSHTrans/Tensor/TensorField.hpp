...
/// by a symmetric permutation *is* that same view, one related by an
...
class TensorField {
 public:
  ...
  /// in MultiIndex.hpp for why the second is not something a
  /// requires-expression could catch on its own.
  template <Int... Alphas>
