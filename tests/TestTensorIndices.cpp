...
static_assert(
    TensorSymmetry<GeneratedBy<2, SlotPermutation<2>{{1, 0}, -1}>, 2>);
static_assert(
    !TensorSymmetry<GeneratedBy<2, SlotPermutation<2>{{0, 0}, 1}>, 2>);
static_assert(
    !TensorSymmetry<GeneratedBy<2, SlotPermutation<2>{{1, 2}, 1}>, 2>);
static_assert(
    !TensorSymmetry<GeneratedBy<2, SlotPermutation<2>{{1, 0}, 2}>, 2>);
